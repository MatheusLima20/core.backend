...
import { makeTransactionCategoryController } from "../factories/transaction-category-controller.factory";
...
router.post("/create", async (request, response) => {
    const controller = makeTransactionCategoryController(request.auth);
